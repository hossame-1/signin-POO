...
if(isset($_POST["submit"])){
   ...
   $ecomerce = new Connection($dbName);
    ...
    //code
    $client1 = new Client($fnameValue, $lnameValue, $emailValue, $passwordValue);

    //call the insertClient method
    //code
    $tableName = "Clients";
    $client1->insertClient($tableName, $ecomerce->conn);
...
<body>
    ...
    <form method="post">
    <div class="row mb-3">
        <label class="col-form-label col-sm-1" for="fname">FirstName:</label>
        <div class="col-sm-6">
        <input value="<?php echo $fnameValue ?>"class="form-control" type="text" id="fname" name="firstName">
        </div>
    </div>
    <div class="row mb-3">
        <label class="col-form-label col-sm-1" for="lname">LastName:</label>
        <div class="col-sm-6">
